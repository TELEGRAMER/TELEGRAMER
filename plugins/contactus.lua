local function do_keyboard_endchat()
    ...
    keyboard.inline_keyboard = {
    	{
    		{text = '🔚 End Chatting', callback_data = '/end'}
	    }
    }
    return keyboard
end
...
api.sendMessage(user_id, '`- Sorry !`\n_You are Blocked By DragonWolf :(_', true) 
 ...
 if msg.chat.type == 'group' and msg.chat.id == -1001311540110 then
...
api.sendMessage(user_id, '_You are UnBlocked_', true) 
    ...
    if msg.reply and msg.reply.forward_from and msg.chat.type == 'group' and msg.chat.id == -1001311540110 then
